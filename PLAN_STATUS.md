...
| T12 | 恢复、安全与异常加固 | re-verifying | 7 | 新版 T12 卡进行中：T12-01~04 完成（跨进程租约 + 编排会话接入 + 反馈心跳/孤儿收口 + 只读状态/doctor 一致性；1183 测试全绿）；T12-05/06 待续 |
