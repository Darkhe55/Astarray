...
| T07D | 多 Provider 生产运行时与独立 Agent 工作助手 | in_progress | 6I | T07D-00~06 完成（1022 测试全绿）；T07D-07 待 T05D/T07E 通过 |
| T07E | Agent 工作集与默认10文件读取预算 | in_progress | pre-T07D | T07E-01 契约完成（ADR-0029；1074 测试全绿）；T07E-02 起按检查点推进 |
