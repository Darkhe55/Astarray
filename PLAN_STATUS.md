...
| T05D | 人工与 Agent 并行编码、冲突协调及受控合并 | pending | pre-T07D | 待 T05B/T06A/T08C 通过；见独立任务卡 |
...
| T07C | Agent 独立模型/Provider 策略与任务类型预设 | pending | 6H | 待 T08D 通过后单独实现；见 ADR-0026 和新任务卡 |
...
| T08D | 阶段性“工匠”三级 Agent与工作流定制 | in_progress | 6G | T08D-01~05 完成（905 测试全绿）；待 T08D-06（三入口设置/披露/tarball 验收） |
...
| T12A | 统一会话恢复、任务续接与外部状态对账 | pending | pre-T12 | 待 T05D/T07E/T07D/T08A 通过；见独立任务卡 |
