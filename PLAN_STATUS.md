...
| T12 | 恢复、安全与异常加固 | re-verifying | 7 | 新版 T12 卡进行中：T12-01/02 完成（跨进程租约 + 编排会话接入 + CLI 并发门禁；1176 测试全绿）；T12-03~06 待续 |
