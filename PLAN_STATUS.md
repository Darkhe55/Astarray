...
> 2026-09-09 进度：T09A-01 完成（ADR-0031 冻结；全局记录/预算/延后片段/上下文图/关闭胶囊/回访与人工验收策略 schema，12 例红灯反例转绿；`npm run check` exit 0，1212 测试全绿）。
>
...
| T09A | 全局决策提升、局部上下文节点关闭与分级回访 | in_progress | post-T12增补 | T09A-01 完成（ADR-0031 + 契约 schema 12 红灯→绿；`npm run check` exit 0，1212 测试全绿）；T09A-02~08 待续 |
