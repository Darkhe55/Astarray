...
| T12 | 恢复、安全与异常加固 | re-verifying | 7 | 新版 T12 卡进行中：T12-01~05 完成（跨进程租约 + 编排会话接入 + 反馈心跳/孤儿收口 + 只读状态/doctor 一致性 + 破坏性 API 静态门禁；1185 测试全绿）；T12-06 待续 |
