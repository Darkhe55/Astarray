...
>
> **2026-09-19 刷新**：本地可证项已在提交 `6461690` 上重跑并更新，见 `docs/reports/E2E01_04_LOCAL_REFRESH_2026-09-19.md`（228 文件/1854 用例、全局 93.09/85.24/93.13/93.11、关键安全模块 22/22、tarball 215 文件 sha256 `a45ae4da…d1f`、E2E-01-01 fixture 复现一致）。本文以下数字为 2026-09-10 当时记录，保留作历史。
